...
public class Constant {
    ...
    //修改以下两个参数，由电信平台提供.
    public static final String APPID = "_FY5origePZOdAjnhPD2Qdrqzooa";
    public static final String SECRET = "EUi9kDTxT6HGHp7FX2pcR3HNs_4a";
    /*
     *IP and port of callback url.
     *请将这个url改成你的云服务器网址
     */
    public static final String CALLBACK_BASE_URL = "http://62.234.1.15:8093/ReceiveLancareData.ashx";
